calculate_enrichment_score<- function(dds, sample_names, p_val_thr, fc_thr, output_location, groups){
  require(tidyverse)
  ...
  enrichment_score<- bind_contrast_tables[bind_contrast_tables$pvalue<p_val_thr & bind_contrast_tables$log2FoldChange>fc_thr,]
